...
class SearchFilter(Base):
    ...
    user: Mapped['User'] = relationship(back_populates='search_filter', cascade="all, delete-orphan")
...
class BlackList(Base):
    ...
    user: Mapped['User'] = relationship(back_populates='blacklist', cascade="all, delete-orphan")
...
class Token(Base):
    ...
    user: Mapped['User'] = relationship(back_populates='token', cascade="all, delete-orphan")
